    ...
    return (
        <div className={styles.pageContainer}>
            <NavBarLogo currPage={"Products"} />
                ...
                <p className={inStock? styles.inStock : styles.outStock}>{inStock? "In-Stock" : "Out of Stock"}</p>
                <p className={styles.numStock}>{num} left</p>
                <p className={styles.prodBottomNote}>For purchasing inquiries, please contact the nail salon.</p>
            <Footer />
        </div>
    );
};
