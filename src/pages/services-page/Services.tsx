    ...
    return (
        <div className={styles.servicesMainContainer}>
            ...
            <div className={styles.breadcrumbContainer}>
                ...
                <button className={currPage === 1? styles.currBtn : styles.nonCurrBtn} onClick={() => handleNextService(1)}/>
                <button className={currPage === 2? styles.currBtn : styles.nonCurrBtn} onClick={() => handleNextService(2)}/>
            </div>
